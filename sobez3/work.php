                ...
                <div class="modal-body">
                    <form id="buy" method="post">
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" id="surname" placeholder="Ваша фамилия">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" id="patronymic" placeholder="Ваше отчество">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="date(DATE_RFC822)">
                        </div>
                        <div class="form-group">
